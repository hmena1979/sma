...
@section('breadcrumb')
	...
	<li class="breadcrumb-item">
		<a href="{{ route('company.reportes.detalle',$detservicio->servicio->id) }}"><i class="fas fa-search"></i> {{ $detservicio->servicio->glosa }}</a>
	</li>
@endsection

@section('content')
	<div class="container-fluid mtop16">
		@include('company.reportes.cabecera')
        <div class="row mtop16">
            <div class="col-md-12">
                {!! Form::open(['route'=>['company.reportes.print',$detservicio],'target'=>"_blank"]) !!}
                <div class="panel shadow">
                    <div class="header">
                        ...
                        <ul>
                            <li>
                                {!! Form::submit('Generar', ['class'=>'btn btn-sma mt-2','id'=>'generar']) !!}
                            </li>
                        </ul>
                    </div>
                    <div class="inside">
                        <div class="row mt-2">
                            <h5 class="ml-3">
                                <strong class="colorprin">EXÁMENES REALIZADOS:</strong>
                            </h5>
                        </div>
                        <div class="row">
