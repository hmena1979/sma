...
@section('contenido')
	<div class="container-fluid">
        {!! Form::model($prueba,['route'=>['admin.pruebas.update',$prueba],'method'=>'put']) !!}
		<div class="row">
			<div class="col-md-12">
					...
					<div class="inside">
						<div class="row">
                            ...
                            <div class="col-md-2 form-group">
                                ...
                                {!! Form::select('tipo',[1=>'NORMAL',2=>'SEXO',3=>'EDAD'],null,['class'=>'custom-select']) !!}
                            </div>
						</div>
                        <div class="row">
                            ...
                            <div class="col-md-2 form-group">
								...
								{!! Form::text('metodo', null, ['class'=>'form-control','maxlength'=>'20','autocomplete'=>'off']) !!}
							</div>
                            <div class="col-md-2 form-group">
                                {!! Form::label('toxicologico', 'Toxicológico:') !!}
                                {!! Form::select('toxicologico',[1=>'SI',2=>'NO'],null,['class'=>'custom-select']) !!}
                            </div>
                        </div>
					</div>
				</div>
