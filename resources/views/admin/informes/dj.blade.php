                    ...
                    <div class="inside">
                        <div class="row mt-1">
                            <div class="col-md-12 form-group">
                                {!! Form::label('confidencial', 'DECLARACIÓN JURADA:',['class' => 'colorprin']) !!}
                                @if(empty($detservicio->informe->dj))
                                {!! Form::textarea('dj',$dj,['class'=>'form-control mayuscula', 'id'=>'editor']) !!}
                                @else
                                {!! Form::textarea('dj',null,['class'=>'form-control mayuscula', 'id'=>'editor']) !!}
                                @endif
                            </div>
                        </div>
                    </div>
