...
<div class="container-fluid">
        {!! Form::open(['route'=>'admin.doctors.store','files' => true]) !!}
		<div class="row">
					...
					<div class="inside">
						<div class="row">
							...
							<div class="col-md-5 form-group">
								...
								{!! Form::text('nombre', '', ['class'=>'form-control mayuscula','autocomplete'=>'off']) !!}
							</div>
				...
				<div class="panelprin shadow">
					<div class="inside">
                        ...
                        <div class="row mt-1 text-center">
                            <div class="col-md-12">
                                <a class="btn btn-convertir" href="#" id="btnfirma">Cargar Archivo</a>
                            </div>
                        </div>
                    </div>
                </div>
